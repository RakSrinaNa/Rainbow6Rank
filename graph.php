...
<script type='text/javascript'>
    ...
    $(document).ready(function () {
        ...
        var chartHolderWatched = document.getElementById('chartHolderRanked5');
        var chartdivWatched = document.getElementById('chartDivRanked5');
        ...
        AmCharts.ready(function () {
            ...
            var datas = JSON.parse('<?php echo getJSONFromFiles(); ?>');
