<?php
{
    ...
    <nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top" role="navigation">
        ...
        <ul class="nav navbar-nav ml-auto">
            <li class="nav-item"><a class="nav-link">Last update
                    at: <?php echo getLastCheckDate($rootDir) ?></a></li>
            <li class="nav-item"><a class="nav-link">Last data
                    from: <?php echo getLastUpdateDate($rootDir); ?></a></li>
        </ul>
        <ul class="nav navbar-nav ml-auto">
